...
categories: email
excerpt: In this article, we will look at <em>"What Email Spoofing is ?"</em> and the preventive measures like SPF, DKIM and DMARC that were introduced to prevent it.
